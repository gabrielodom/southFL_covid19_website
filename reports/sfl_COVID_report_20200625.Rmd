...
southFloridaHospitalised_df <- 
	read_csv(
		file = "../../data/ESS_southFL_summary_20200624.csv"
	)
...
```{r md_read_data}
mdCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_miamidade_20200625.csv"
) %>% 
...
browCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_broward_20200625.csv"
) %>% 
	mutate(PropPositive = 100 * Positive / (Positive + Negative)) %>% 
...
```{r pb_read_data}
pbCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_palmbeach_20200625.csv"
) %>% 
	mutate(PropPositive = 100 * Positive / (Positive + Negative))
```
