...
southFloridaHospitalised_df <- 
	read_csv(
		file = "../../data/ESS_southFL_summary_20200714.csv"
	)
...
# Gabriel's Machine:
mdCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_miamidade_20200714.csv"
) 
...
browCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_broward_20200714.csv"
) %>% 
	mutate(PropPositive = 100 * Positive / (Positive + Negative)) %>% 
	mutate(PositivePer1k = (PropPositive / 100) * 1000) %>% 
...
```{r pb_read_data}
pbCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_palmbeach_20200714.csv"
) %>% 
	mutate(PropPositive = 100 * Positive / (Positive + Negative)) %>% 
	mutate(PositivePer1k = (PropPositive / 100) * 1000)
```
