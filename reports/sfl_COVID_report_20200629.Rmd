...
```{r md_read_data}
mdCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_miamidade_20200629.csv"
) %>% 
...
browCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_broward_20200629.csv"
) %>% 
	mutate(PropPositive = 100 * Positive / (Positive + Negative)) %>% 
	mutate(PositivePer1k = (PropPositive / 100) * 1000) %>% 
...
```{r pb_read_data}
pbCases_df <- read_csv(
	file = "../../data/FLDH_COVID19_cases_palmbeach_20200629.csv"
) %>% 
	mutate(PropPositive = 100 * Positive / (Positive + Negative)) %>% 
	mutate(PositivePer1k = (PropPositive / 100) * 1000)
```
