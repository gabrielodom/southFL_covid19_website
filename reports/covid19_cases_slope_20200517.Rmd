...
sflCases_df <- read_excel(
	path = "../../data/FLDH_COVID19_cases_20200517.xlsx"
)
```
...
ggplot(data = sflCases2_df) +
	...
	labs(
		...
		subtitle = "2 April to 16 May, 2020",
...
ggplot(
	...
	labs(
		title = "Proportion of Positive COVID-19 in Miami Dade County",
		subtitle = paste(
			"27 April to 12 May, 2020; Linear Change =",
			round(slope2, 3)
		),
		caption = "Solid line represents the LOESS Predictor; Dashed line for Linear.",
		y = "Proportion of Positive Cases"
...
ggplot(
	...
	labs(
		title = "Proportion of Positive COVID-19 in Miami Dade County",
		subtitle = paste(
			"2 May to 16 May, 2020; Linear Change =",
			round(slope3, 3)
		),
		caption = "Solid line represents the LOESS Predictor; Dashed line for Linear.",
		y = "Proportion of Positive Cases"
...
ggplot(
	...
	labs(
		...
		subtitle = "Miami Dade County: 2 April to 16 May, 2020",
		y = "Net Admits"
	) +
