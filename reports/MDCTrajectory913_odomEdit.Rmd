...
sflCases_df <- read_csv(
	file = "../../data/cases/FLDH_COVID19_cases_miamidade_20200928.csv"
) %>% 
...
There was a general decrease in the number of new positive test results from early April until around May 18th, the day Miami-Dade County reopened. Afterwards, this trend flattened out and then increased until late July before it started to decrease. **Over the past two weeks, there has been an average decrease of 14 fewer positive cases each day.** This is compared with a decrease of 26 fewer new positive cases each day from the previous analysis.
...
During the 14-day period from `r recentStartEnd_date[1]` to `r recentStartEnd_date[2]`, there was a <b> `r adjective` `r if (recentSlope_num > 0) "increase" else "decrease"` </b> in the proportion of positive COVID-19 cases reported in Miami-Dade County. During this time, there was an average change of  `r round(recentSlope_num, 1)`% per day for new positive cases. This rate of decrease is compared with a decrease of -0.194 from the previous analyis on September 8th. Given a flat or increasing number of tests performed, the proportion of positive tests obtained is the **key metric** for examining COVID-19 trajectory.
...
Overall, the proportion of positive test results out of all tests decreased significantly from over 20% in April to 5% on May 18th, the date Miami-Dade County reopened. **After reopening, the proportion of positive tests increased steadily until late July. Subsequently, there has been a consistent decline in positivity rate, reaching the current average.** This number is function of test availability and the population being tested.
...
miamidadeHospitalized_df <- read_csv(
	file = "../../data/ESS_processed/ESS_southFL_summary_20200929.csv"
) %>% 
...
**Recently, on September 13th, there were 533 COVID positive patients hospitalized. This was a decrease from a high of 2299 obtained on July 21st. Additionally on September 13th, there were 169 COVID positive patients in the ICU. This was a decrease from from a high of 561 obtained on July 26th. Furthermore, on September 13th, there were 131 COVID positive patients ventilated. This was a decrease from a high of 335 obtained on July 24th. This represents a decreasing hospitalization burden** Note: data is plotted on a log scale.
...
deathsbyday_df <- read_csv(
	file = "../../data/deaths/FLDH_COVID19_deathsbyday_bycounty_20201001.csv"
) %>% 
...
Overall from March 16th to  approximately May 25th in Miami-Dade County, there was a  decrease in the number of deaths per day. The orange triangle depicts the county reopening date. This decrease in deaths may be attributable to advances in COVID-19 treatments and standard of care. A decrease in median age of those impacted could also partially explain this decrease. **After May 25th, there has been an increase in deaths reported per day for Miami-Dade County. The peak number of deaths so far reported was 64 on July 6th.**

**Note: Due to delays in classifying the cause of death and thus of reporting deaths due to COVID-19, the most recent data will undercount the number of deaths. For this reason, the last eight weeks were excluded from this analysis of deaths.**

*******************************************************************************

# Conclusion

During the past two weeks, the number of positive COVID-19 tests obtained has **decreased** by an average of 14 fewer positive tests each day. The proportion of positive COVID-19 tests is still decreasing. The number of people with COVID-19 who are hospitalized, in the ICU and on ventilators is also continuing to decrease.
