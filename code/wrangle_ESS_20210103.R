...
###  February 7th, 9th  ###
southFloridaHospitalised_ls[c(300, 302:333)] <-
	map2(
		.x = dataFiles_char[c(300, 302:333)],
		.y = c(
			...
			"2021-03-06", "2021-03-07", "2021-03-08", "2021-03-10", "2021-03-11",
...
###  March 15th, 16th  ###
southFloridaHospitalised_ls[336:359] <-
	map2(
		.x = dataFiles_char[336:359],
		.y = c(
...
###  April 10th  ###
southFloridaHospitalised_ls[361:393] <-
	map2(
		.x = dataFiles_char[361:393],
		.y = c(
			...
			"2021-05-01", "2021-05-03", "2021-05-04", "2021-05-05", "2021-05-06",
